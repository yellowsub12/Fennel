    ...
    <div className='header' data-testid="header">
      ...
      <div class="container-fluid">
          <div class="row align-items-center">
              ...
              <Link to="/"><span class="logo">Fennel</span></Link> </a> </div>
              <div class="col-lg-4 col-xl-5 col-sm-8 col-md-4 d-none d-md-block">
                  <form action="#" class="search-wrap">
                      <div class="input-group w-100"> <input type="text" class="form-control search-form" placeholder="Search LOL"/>
              ...
              <div class="col-lg-5 col-xl-4 col-sm-8 col-md-4 col-7">
                  ...
                  <Link to="/"><a data-abc="true" class="nav-link widget-header">Hello {!user ? 'Guest' : user.email}</a></Link>
      ...
      <div class="container-fluid">
          ...
          <div class="navbar-collapse collapse" id="dropdown6" >
              <ul class="navbar-nav mr-auto">
                  ...
                  <Link to="/Category"><a class="nav-link dropdown-toggle"  data-toggle="dropdown"  >Categories</a></Link>
